...
```
$ go get -d github.com/sethAmazon/cadvisor
```
...
```
$GOPATH/src/github.com/sethAmazon/cadvisor $ make build
```

or run only unit tests:

```
$GOPATH/src/github.com/sethAmazon/cadvisor $ make test
```
...
```
$GOPATH/src/github.com/sethAmazon/cadvisor $ GO_FLAGS="-tags=libipmctl,netgo" make build
```
...
```
$GOPATH/src/github.com/sethAmazon/cadvisor $ GO_FLAGS="-tags=libpfm,netgo" make build
```
...
```
$GOPATH/src/github.com/sethAmazon/cadvisor $ sudo ./cadvisor
```
...
```
$GOPATH/src/github.com/sethAmazon/cadvisor $ sudo ./cadvisor -perf_events_config=perf/testing/perf-non-hardware.json
